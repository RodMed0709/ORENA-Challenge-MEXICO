...
- [[headline-arithmetic-four-cells]] — `bucket_mean` is 4 equal cells and `fo_class` is 71 %/83 % of the `object_recognition` pair, so a `fo_class`-only +0.02 buys **+0.004** of headline. Ask "does it move a whole cell?", not "does it help?".

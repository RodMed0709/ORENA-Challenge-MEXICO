...
FEWSHOT_EXEMPLARS = (
    "EXAMPLE (number) — note: evidence LOCATES each object, the total is only in <thought>:\n"
    "QUESTION: How many Clips appear in this frame?  GOLD: 2\n"
    "<description>A laparoscopic field with metal hardware on the duct.</description>"
    "<evidence>Small V-shaped metallic objects on the duct — one at left, one lower right.</evidence>"
    "<thought>Counting them: two.</thought><answer>2</answer>\n\n"
    "EXAMPLE (fo_class) — note: evidence gives TEXTURE, not the class name:\n"
    "QUESTION: List all foreign objects visible.  GOLD: Sponge\n"
    "<description>Soft material on tissue.</description>"
    "<evidence>A white, woven, fibrous patch.</evidence>"
...
GEN_PROMPT_VISION_TEMPLATE = (
    ...
    "<description>1 short clause: the scene.</description>"
    "<evidence>the visual features the answer rests on — shape/color/texture/location you see.</evidence>"
    "<thought>one step from evidence to the answer.</thought><answer>GOLD</answer>\n\n"
    "HARD RULES:\n"
    "- <answer> MUST be exactly: {gold}\n"
